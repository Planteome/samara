...
trait NameFinderTaxonCachePO extends NameFinderTaxonCache {
  override def taxonMapCacheConfig: TaxonMapCache = {
    ...
    TaxonMapCache(name = "PO", lineFilter = lineFilter, prefixFilter = prefixFilter, prefixMap = prefixMap, expandId = expandId)
  }
}
